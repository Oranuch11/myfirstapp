...
async function loadFacts() {
  const res = await fetch(
    "https://wuxzzffqtoofdlepzqzd.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind1eHp6ZmZxdG9vZmRsZXB6cXpkIiwicm9sZSI6ImFub24iLCJpYXQiOjE2Nzk0MDk4MzMsImV4cCI6MTk5NDk4NTgzM30.RkmXtgq62iVOXj-InbnoxfcQ0n0KwfpHj_ta7HOkb6M",
      },
    }
  );
